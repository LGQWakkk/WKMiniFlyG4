...
from elrs_radio import JoystickThread
...
####################################################################################
                ...
                # print(f"Control: Roll {-control[1]:+05.2f}, Pitch {control[0]:+05.2f}, Yaw {-control[2]:+05.2f}, Thrust {control[3]:+05.2f}")
                roll_control = -control[1]
                pitch_control = control[0]
                yaw_control = -control[2]
                thrust_control = control[3]
